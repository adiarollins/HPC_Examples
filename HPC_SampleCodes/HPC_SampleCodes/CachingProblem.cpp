...
// Simple Threading Examples - 9
// Multithreading Slower than Single Threading Problem
// Use one sum and show the racing problem first!!!!
...
long* sumeach = new long[numofthreads];
